...
url = "https://9ce2265e4c964b519ec125afec12e985.us-central1.gcp.cloud.es.io:9243/api/detection_engine/rules"
...
for root, dirs, files in os.walk(r"C:\Users\igord\OneDrive\Documents\Detection Engineering\converted_detections"):
    for file in files:
        data = "{\n"
